...
* @constructor
* @param {object} credentials                    The authentication object for the client.
* @param {string} baseUri						 The management service endpoint Uri.
*
* You must use either token or key/cert to authenticate service requests.
* @param {string} [credentials.subscriptionId]      The subscription identifier.
* @param {string} [credentials.token]               The access token.
...
* @param {string} [credentials.key]                 The key value.
*/
exports.createHDInsightClusterManagementClient = function (credentials, baseUri) {
	return new exports.HDInsightClusterManagementClient.HDInsightClusterManagementClient(credentials, baseUri);
};
...
* @param {string} [credentials.key]                 The key value.
*/
exports.createHDInsightCluster2ManagementClient = function (credentials, baseUri) {
	return new exports.HDInsightCluster2ManagementClient.HDInsightCluster2ManagementClient(credentials, baseUri);
};
